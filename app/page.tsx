...
// import myPhoto from "./profile.jpg"; // Uncomment this if you used Method 2 for your photo
...
export default function AttendanceCalculator() {
  ...
  // NEW STATE: Tracks if the profile image is open in full-screen
  ...
  return (
    <div className="relative min-h-screen bg-[#0f172a] text-white flex flex-col items-center justify-center p-4 font-sans overflow-hidden">
      ...
      {/* MAIN CARD */}
      <div className="relative w-full max-w-md bg-gray-900/60 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-gray-700/50 z-10 my-4">
      ...
      <footer className="relative z-10 mt-6 flex flex-col items-center space-y-4">
        <div className="flex items-center space-x-3 bg-gray-900/60 backdrop-blur-md px-5 py-2.5 rounded-full border border-gray-700/50 shadow-lg">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://www.linkedin.com/in/naman-kanyal-b2709b431/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200" aria-label="GitHub">
            ...
            <a href="https://linkedin.com/in/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500 transition-colors duration-200" aria-label="LinkedIn">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 114.125 0 2.062 2.062 0 01-2.062 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" clipRule="evenodd"/></svg>
            </a>
            <a href="https://www.instagram.com/whyso_cool_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500 transition-colors duration-200" aria-label="Instagram">
      ...
      {isImageOpen && (
        ...
        >
          <div 
            className="relative max-w-sm w-full animate-popup shadow-2xl"
            onClick={(e) => e.stopPropagation()} // Prevents clicking the image itself from closing it
          >
            {/* CLOSE BUTTON */}
            <button 
              onClick={() => setIsImageOpen(false)}
              className="absolute -top-4 -right-4 w-10 h-10 flex items-center justify-center bg-gray-800 text-white rounded-full border-2 border-gray-600 hover:bg-gray-700 hover:border-gray-500 transition-colors duration-200 shadow-xl z-50"
            >
              ✕
            </button>
            ...
            <img 
              src="/suitme2.jpeg" 
              alt="Profile Icon Enlarged" 
              className="w-full h-auto rounded-2xl border border-gray-700/50 object-cover"
            />
          </div>
        </div>
      )}
