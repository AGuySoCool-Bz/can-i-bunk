        ...
        <div className="flex items-center space-x-3 bg-gray-900/60 backdrop-blur-md px-5 py-2.5 rounded-full border border-gray-700/50 shadow-lg">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative flex items-center">
              <a href="https://instagram.com/whyso_cool_/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500 transition-colors duration-200" aria-label="Instagram">
              ...
              {/* WHITE POPUP BOX */}
              {showFeedbackPopup && (
                <div className="absolute bottom-full right-0 mb-3 w-48 p-2.5 bg-white text-gray-800 text-xs rounded-lg shadow-xl text-center animate-popup pointer-events-none">
                  Please leave your honest review or any feedback on my Insta DM!
                  {/* Small white triangle pointing down */}
                  <div className="absolute top-full right-1.5 border-4 border-transparent border-t-white"></div>
                </div>
              )}
            </div>
          </div>
