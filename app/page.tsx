        ...
        <div className="flex items-center space-x-3 bg-gray-900/60 backdrop-blur-md px-5 py-2.5 rounded-full border border-gray-700/50 shadow-lg">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative flex items-center">
              ...
              {/* WHITE POPUP BOX */}
              {showFeedbackPopup && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-48 p-2.5 bg-white text-gray-800 text-xs rounded-lg shadow-xl text-center animate-popup pointer-events-none">
